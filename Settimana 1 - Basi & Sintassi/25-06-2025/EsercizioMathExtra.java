public class EsercizioMathExtra {
    public static void main(String[] args) {
        ...
        double altezza = (1 + Math.random());  //random con una generazione d'altezza realistica
        System.out.println("Altezza: " + altezza);

        System.out.println("Qual è il tuo peso (in Kg)?");
        double peso = (int) (40 + Math.random() * 51);  //random con generazione del peso realistica
